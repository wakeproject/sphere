...
public:
    ...
    void test_pxir_by_rind_0(void)
    {
        TS_ASSERT_EQUALS(pxir_by_rind(0,  0), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  1), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  2), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  3), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  4), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  5), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  6), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  7), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  8), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(0,  9), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(0, 10), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(0, 11), 4);
    }

    void test_pxir_by_rind_1(void)
    {
        TS_ASSERT_EQUALS(pxir_by_rind(1,  0), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  1), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  2), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  3), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  4), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  5), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  6), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  7), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  8), 5);
        TS_ASSERT_EQUALS(pxir_by_rind(1,  9), 6);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 10), 7);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 11), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 12), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 13), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 14), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 15), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 16), 5);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 17), 6);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 18), 7);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 19), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 20), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 21), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 22), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 23), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 24), 5);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 25), 6);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 26), 7);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 27), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 28), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 29), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 30), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 31), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 32), 5);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 33), 6);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 34), 7);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 35), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 36), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 37), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 38), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 39), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 40), 5);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 41), 6);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 42), 7);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 43), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 44), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 45), 2);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 46), 3);
        TS_ASSERT_EQUALS(pxir_by_rind(1, 47), 4);
    }

    void test_pxir_by_rind_2(void)
    {
        TS_ASSERT_EQUALS(pxir_by_rind(2,   0), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,   3), 4);
        TS_ASSERT_EQUALS(pxir_by_rind(2,   4), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  11), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  12), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  23), 12);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  24), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  39), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  40), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  55), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  56), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  71), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  72), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  87), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2,  88), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 103), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 104), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 119), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 120), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 135), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 136), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 151), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 152), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 167), 16);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 168), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 179), 12);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 180), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 187), 8);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 188), 1);
        TS_ASSERT_EQUALS(pxir_by_rind(2, 191), 4);
    }
};
